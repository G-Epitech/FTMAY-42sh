...
simple = Test("Simple inhibitors", "echo \"\\tata\"")
suite.addTest(simple)

simple_without = Test("Simple inhibitors without quote", "echo \\tata")
suite.addTest(simple_without)

multiple = Test("Multiple inhibitors", "echo \"\\ta\\na\"")
suite.addTest(multiple)

multiple_without = Test("Multiple inhibitors without quote", "echo \\ta\\na")
...
bad_inibitors = Test("Bad inhibitors", "echo \"super test n n n ttt t\"")
suite.addTest(bad_inibitors)

bad_inibitors_without = Test("Bad inhibitor without", "echo super test n n n ttt t")
